...
def run(string, entities):
    ...
    for i, domain in enumerate(domains):
        ...
        utils.output('inter', 'checking', utils.translate(
            'checking', {'website_name': websitename}))
        ...
        try:
            ...
            utils.output('inter', 'up', utils.translate(
                state, {'website_name': websitename}))
        except requests.exceptions.RequestException as e:
            utils.output('inter', 'down', utils.translate(
                'errors', {'website_name': websitename}))
